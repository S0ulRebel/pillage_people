...
Import ../meshes/BOTTOM_STERN.glb or OBJ at unit scale. Read ../contract.json.

Bilge and lower hull only. Place once at Y=0; upper connection Y=2.6. No raised posts.
