# STAIR_STARBOARD_START

Import ../meshes/STAIR_STARBOARD_START.glb or OBJ at unit scale. Read ../contract.json.

Replaces one FLOOR_CENTRE. START then END at consecutive bays: 1.1 x 3.25 m open shaft; final 0.75 m solid landing. Never overlay solid floor.
