...

{
  ...
  "mesh": "meshes/U_STERN.obj",
  "notes": "Footprint follows H03_STERN. Open top and bottom. At lengthwise interfaces, side-wall strips only; no transverse bulkhead. Bottom Y=0, top Y=2.6. Locks first/last 0.10 m of each mating surface."
}
